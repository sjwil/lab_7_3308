...
app.get('/team_stats', function(req, res) {
	...
	var wins = 'SELECT count(*) as count from football_games where home_score > visitor_score;'
	var losses = 'SELECt count(*) as count from football_games where visitor_score > home_score;'
...
app.get('/player_info/post', function(req, res) {
	var cur_player = 'SELECT * from football_players where id = ' + req.query.player_choice
	var games_played = 'SELECT count(players) as count from football_games where ' + req.query.player_choice + '= ANY(players)'
	var players = 'SELECT * from football_players;'
